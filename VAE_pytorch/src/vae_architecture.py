...
class Decoder(nn.Module):
    def __init__(self, k):
        ...
        self.conv_2 = nn.ConvTranspose2d(in_channels = 64, out_channels = 64, kernel_size = 16)
        self.batch_norm_2 = nn.BatchNorm2d(num_features = 64)
        
        self.conv_1 = nn.ConvTranspose2d(in_channels = 64, out_channels = 32, kernel_size = 32)
        self.batch_norm_1 = nn.BatchNorm2d(num_features = 32)
        
        self.conv_0 = nn.ConvTranspose2d(in_channels = 32, out_channels = 3, kernel_size = 64)
